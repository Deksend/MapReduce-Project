...
INTERVAL_SIZE = 5         # e.g., 5 for 5-year intervals, 10 for decades
INTERVAL_OFFSET = 0       # e.g., 0 for 2000-2004, 1 for 2001-2005
...
def map_function(document_line):
    try:
        ...
        # Column indexes: 0=Artist, 2=Duration, 4=Year, 17=Genre
        artist_name = row[0]
...
def reduce_function(key, values_list):
    ...
    # Sort the years list for readability
